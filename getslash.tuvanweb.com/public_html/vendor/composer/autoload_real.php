...
class ComposerAutoloaderInit4ff7a59071f57195e7693c2813bff680
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit4ff7a59071f57195e7693c2813bff680::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire4ff7a59071f57195e7693c2813bff680($fileIdentifier, $file);
        }
...
function composerRequire4ff7a59071f57195e7693c2813bff680($fileIdentifier, $file)
{
