					...
					<div class="row align-items-center">
						...
						<div class="col-md-6">
							<div class="shear-detail">
								...
								<ul>
									<li><a href="https://www.facebook.com/sharer.php?u={{ route('press.single', $data->slug) }}"><img src="{{ __BASE_URL__ }}/images/sc-1.png" class="img-fluid" alt="facebook"></a></li>
									<li><a href="https://www.twitter.com/sharer.php?u={{ route('press.single', $data->slug) }}"><img src="{{ __BASE_URL__ }}/images/sc-2.png" class="img-fluid" alt="twitter"></a></li>
									<li><a href="https://www.linkedin.com/shareArticle?mini=true&url={{ route('press.single', $data->slug) }}&title={{ $data->name_vi }}&summary={{ $data->name_vi }}&source={{ $data->name_vi }}"><img src="{{ __BASE_URL__ }}/images/sc-3.png" class="img-fluid" alt="linkedin"></a></li>
									<li><a href="{{ route('press.single', $data->slug) }}"><img src="{{ __BASE_URL__ }}/images/sc-4.png" class="img-fluid" alt="linkedin"></a></li>
								</ul>
							</div>
						</div>
					</div>
