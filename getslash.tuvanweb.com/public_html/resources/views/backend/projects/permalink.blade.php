...
<span id="sample-permalink">
	<a class="permalink" target="_blank" href="{{ asset('projects/'.$data->slug ) }}">
    	<span class="default-slug">
    		{{ asset('projects') }}/<span id="editable-post-name">{{ @$data->slug }}</span>
    	</span>
	</a>
</span>
...
<input type="hidden" id="baseUrl" value="{{ asset('projects') }}">
