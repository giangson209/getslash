				...
				<form action="{{ route('pages.build.post') }}" method="POST">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							...
							<li class="">
								<a href="#contentPages2" data-toggle="tab" aria-expanded="true">Khối Dịch vụ</a>
							</li>

							<li class="">
								<a href="#contentPages3" data-toggle="tab" aria-expanded="true">Khối Tải ứng dụng</a>
							</li>
							...
							<div class="row">
								<div class="col-sm-2">
									<div class="form-group">
										...
										<div class="image">
											<div class="image__thumbnail">
												<img src="{{ @$data->content->khoi3->banner ?  @$data->content->khoi3->banner : __IMAGE_DEFAULT__ }}"
													 data-init="{{ __IMAGE_DEFAULT__ }}">
												<a href="javascript:void(0)" class="image__delete" onclick="urlFileDelete(this)">
													<i class="fa fa-times"></i></a>
												<input type="hidden" value="{{ @$data->content->khoi3->banner }}" name="content[khoi3][banner]"  />
												<div class="image__button" onclick="fileSelect(this)"><i class="fa fa-upload"></i> Upload</div>
											</div>
										</div>
									</div>
								...
								<div class="col-sm-8">
									...
									<div class="form-group">
										<label for="">Nút</label>
										<textarea type="text" class="form-control" name="content[khoi3][nut]">{!! @$data->content->khoi3->nut !!}</textarea>  
									</div>

									<div class="form-group">
										<label for="">Link</label>
										<textarea type="text" class="form-control" name="content[khoi3][link]">{!! @$data->content->khoi3->link !!}</textarea>  
									</div>
								</div>
							</div>
						</div>
