				...
				<form action="{{ route('pages.build.post') }}" method="POST">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							...
							<li class="">
								<a href="#contentPages2" data-toggle="tab" aria-expanded="true">Khối NEWSPAPERS</a>
							</li>

							<li class="">
								<a href="#contentPages3" data-toggle="tab" aria-expanded="true">Khối Press Kit</a>
							</li>
									...
									<div class="form-group">
										...
										<div class="image">
											<div class="image__thumbnail">
												<img src="{{ @$data->content->khoi3->image ?  @$data->content->khoi3->image : __IMAGE_DEFAULT__ }}"
													 data-init="{{ __IMAGE_DEFAULT__ }}">
												<a href="javascript:void(0)" class="image__delete" onclick="urlFileDelete(this)">
													<i class="fa fa-times"></i></a>
												<input type="hidden" value="{{ @$data->content->khoi3->image }}" name="content[khoi3][image]"  />
