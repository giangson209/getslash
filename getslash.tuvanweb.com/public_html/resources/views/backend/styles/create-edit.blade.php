                ...
                <div class="col-sm-9">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                         ...
                         <!--    <li class="">
                                <a href="#detail" data-toggle="tab" aria-expanded="true">Thông tin Tiếng Anh</a>
                            </li> -->
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        @if(isUpdate(@$module['action']))
                                            <div class="form-group" id="edit-slug-box">
                                                @include('backend.styles.permalink')
                                            </div>
                                        @endif
                                        <div class="form-group">
                                            <label for="">Mô tả ngắn</label>
                                            <textarea class="form-control" name="desc_vi" rows="5">{{ old('desc_vi', @$data->desc_vi) }}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label>Mô tả</label>
                                            <textarea name="content_vi" class="content" cols="30" rows="10">{!! old('content_vi', @$data->content_vi) !!}</textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="detail">
                                ...
                                <div class="form-group">
                                    <label for="">Mô tả ngắn</label>
                                    <textarea class="form-control" name="desc_en" rows="5">{{ old('desc_en', @$data->desc_en) }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label>Mô tả</label>
                                    <textarea name="content_en" class="content" cols="30" rows="10">{!! old('content_en', @$data->content_en) !!}</textarea>
                                </div>
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div class="form-group" style="text-align: center;">
                                <div class="image">
                                    <div class="image__thumbnail">
                                        <img src="{{ !empty($data->logo) ? $data->logo : __IMAGE_DEFAULT__ }}"
                                             data-init="{{ __IMAGE_DEFAULT__ }}">
                                        <a href="javascript:void(0)" class="image__delete" onclick="urlFileDelete(this)">
                                            <i class="fa fa-times"></i></a>
                                        <input type="hidden" value="{{ old('logo', @$data->logo) }}" name="logo"/>
                                        <div class="image__button" onclick="fileSelect(this)">
                                            <i class="fa fa-upload"></i>
                                            Upload
                                        </div>
