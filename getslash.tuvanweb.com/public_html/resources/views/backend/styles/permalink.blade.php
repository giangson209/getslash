...
<span id="sample-permalink">
	<a class="permalink" target="_blank" href="{{ asset('style/'.$data->slug ) }}">
    	<span class="default-slug">
    		{{ asset('style') }}/<span id="editable-post-name">{{ @$data->slug }}</span>
    	</span>
	</a>
</span>
...
<input type="hidden" id="baseUrl" value="{{ asset('style') }}">
