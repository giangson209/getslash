                            ...
                            <div class="tab-pane active" id="activity">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <label>Mô tả</label>
                                            <textarea name="desc_vi" class="content" cols="30" rows="10">{!! old('desc_vi', @$data->desc_vi) !!}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label>Địa chỉ</label>
                                            <input type="text" class="form-control" name="address_vi" value="{!! old('address_vi', @$data->address_vi) !!}" >
                                        </div>

                                   <!--      <div class="form-group">
                                            <label>Số lượng</label>
                                            <input type="text" class="form-control" name="qty" value="{!! old('qty', @$data->qty) !!}" >
                                        </div> -->

                                        <div class="form-group">
                                            <label>Mức lương</label>
                                            <input type="text" class="form-control" name="offers_vi" value="{!! old('offers_vi', @$data->offers_vi) !!}" >
                                        </div>
                                  <!--       <div class="form-group">
                                            <label>Ngày kết thúc</label>
                                            <input type="text" class="form-control" name="deadline" value="{!! old('deadline', @$data->deadline) !!}" >
                                        </div> -->
                                        <div class="form-group">
                                            <label>EMPLOYMENT TYPE</label>
                                            <input type="text" class="form-control" name="type" value="{!! old('type', @$data->type) !!}" >
                                        </div>
